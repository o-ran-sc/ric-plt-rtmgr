...
func NewRoutingManagerAPI(spec *loads.Document) *RoutingManagerAPI {
	return &RoutingManagerAPI{
		...
		HandleProvideXappSubscriptionHandleHandler: handle.ProvideXappSubscriptionHandleHandlerFunc(func(params handle.ProvideXappSubscriptionHandleParams) middleware.Responder {
			return middleware.NotImplemented("operation HandleProvideXappSubscriptionHandle has not yet been implemented")
		}),
	}
}
...
type RoutingManagerAPI struct {
	...
	// HandleProvideXappSubscriptionHandleHandler sets the operation handler for the provide xapp subscription handle operation
	HandleProvideXappSubscriptionHandleHandler handle.ProvideXappSubscriptionHandleHandler
...
func (o *RoutingManagerAPI) Validate() error {
	...
	if o.HandleProvideXappSubscriptionHandleHandler == nil {
		unregistered = append(unregistered, "handle.ProvideXappSubscriptionHandleHandler")
	}
...
func (o *RoutingManagerAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/handles/xapp-subscription-handle"] = handle.NewProvideXappSubscriptionHandle(o.context, o.HandleProvideXappSubscriptionHandleHandler)
