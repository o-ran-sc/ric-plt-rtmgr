...
// WithSubscriptionRequest adds the subscriptionRequest to the add subscription params
func (o *AddSubscriptionParams) WithSubscriptionRequest(subscriptionRequest *appmgr_model.SubscriptionRequest) *AddSubscriptionParams {
	o.SetSubscriptionRequest(subscriptionRequest)
	return o
}

// SetSubscriptionRequest adds the subscriptionRequest to the add subscription params
func (o *AddSubscriptionParams) SetSubscriptionRequest(subscriptionRequest *appmgr_model.SubscriptionRequest) {
