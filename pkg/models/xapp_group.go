...
// XappGroup xapp group
// swagger:model xapp-group
type XappGroup []*XappInstance

// Validate validates this xapp group
func (m XappGroup) Validate(formats strfmt.Registry) error {
	var res []error
